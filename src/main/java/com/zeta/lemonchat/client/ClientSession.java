...
import com.zeta.client.module.impl.client.Capes;
import com.zeta.lemonchat.client.codec.PDecoder;
import com.zeta.lemonchat.network.Packet;
import com.zeta.lemonchat.network.c2s.*;
import com.zeta.lemonchat.network.s2c.*;
import com.zeta.lemonchat.utils.*;
...
import static com.zeta.lemonchat.client.ChatClient.LOGGER;
    ...
    public void tick() {
        ...
        if (this.tickCount % 60 == 0) {
            if (mc != null && mc.world != null && mc.player != null) {
                String capeId = "None";
                Capes cape = Zeta.MODULES.getModule(Capes.class);
