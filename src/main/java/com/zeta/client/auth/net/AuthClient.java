package com.zeta.client.auth.net;
...
public final class AuthClient {
    ...
    private static final String DEFAULT_BASE_URL = "http://82.158.88.52:8443";
    ...
    public CompletableFuture<AuthVerifyResult> login(String username, String password, String deviceId) {
        ...
        return handshake()
                .thenCompose(session -> {
                    ...
                    payload.addProperty("clientVersion", Zeta.MOD_VER);
    ...
    private static SSLContext tryBuildTlsContextFromProps() {
        String keystorePath = getProp("zeta.auth.tls.keystorePath");
        String keystorePassword = getProp("zeta.auth.tls.keystorePassword");
        String truststorePath = getProp("zeta.auth.tls.truststorePath");
        String truststorePassword = getProp("zeta.auth.tls.truststorePassword");
