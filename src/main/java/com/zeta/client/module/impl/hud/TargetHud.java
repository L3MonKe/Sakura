...
import com.zeta.client.module.impl.combat.KillAura;
...
public class TargetHud extends HudModule {
    ...
    private static final Identifier TARGET_TEX = Identifier.of("zeta", "textures/particles/target.png");
    private static final Identifier TARGET1_TEX = Identifier.of("zeta", "textures/particles/target1.png");
    ...
    private LivingEntity getCurrentTarget() {
        KillAura killAura = Zeta.MODULES.getModule(KillAura.class);
