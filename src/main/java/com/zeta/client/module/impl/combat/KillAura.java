package com.zeta.client.module.impl.combat;
...
import com.zeta.client.manager.impl.RotationManager;
import com.zeta.client.module.Category;
import com.zeta.client.module.Module;
import com.zeta.client.module.impl.movement.Scaffold;
import com.zeta.client.module.impl.player.Blink;
import com.zeta.client.utils.render.Render3DUtil;
import com.zeta.client.utils.rotation.MovementFix;
import com.zeta.client.utils.rotation.RotationUtil;
import com.zeta.client.utils.vector.Rotation;
...
public class KillAura extends Module {
    ...
    public void onPreTick(TickEvent.Pre event) {
        ...
        boolean scaffoldEnable = Zeta.MODULES.getModule(Scaffold.class).isEnabled();
        boolean blinkEnable = Zeta.MODULES.getModule(Blink.class).isEnabled();
