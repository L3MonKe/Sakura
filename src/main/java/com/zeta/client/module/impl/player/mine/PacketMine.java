package com.zeta.client.module.impl.player.mine;

import com.zeta.client.Zeta;
import com.zeta.client.events.client.TickEvent;
import com.zeta.client.events.player.BlockEvent;
...
import com.zeta.client.utils.player.InvUtil;
...
//            hookPos(blockData2.getCurrentPos(), false);
    ...
    public void hookPos(BlockPos blockPos, boolean reset) {
        ...
        if (blockPos != blockData2.getCurrentPos()) Zeta.EVENT_BUS.post(new BlockEvent(blockPos, side));
    }
