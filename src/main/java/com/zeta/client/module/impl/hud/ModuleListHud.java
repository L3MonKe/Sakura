...
public class ModuleListHud extends HudModule {
    ...
    private boolean isHudEditorOpen() {
        HudEditor editor = Zeta.MODULES.getModule(HudEditor.class);
    ...
    private void updateModuleList() {
        List<Module> enabledModules = Zeta.MODULES.getAllModules().stream()
    ...
    private void loadIcon() {
        iconImage = NanoVGHelper.loadTexture("/assets/zeta/icons/icon_32x32.png");
    }
