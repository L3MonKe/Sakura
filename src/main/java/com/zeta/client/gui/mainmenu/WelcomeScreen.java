...
import com.zeta.client.gui.component.AdvancedColorPicker;
...
import com.zeta.client.utils.TranslationManager;
...
public class WelcomeScreen extends Screen {
    ...
    private void finishWizard() {
        ClickGui clickGui = Zeta.MODULES.getModule(ClickGui.class);
        if (clickGui != null) {
    ...
    private void loadPi8Image() {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                InputStream is = Zeta.class.getResourceAsStream("/assets/zeta/textures/pi8.jpg");
                if (is == null) {
