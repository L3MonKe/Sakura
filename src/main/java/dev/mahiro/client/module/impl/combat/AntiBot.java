...
public class AntiBot extends Module {
    ...
    public static boolean isBedWarsBot(Entity entity) {
        AntiBot module = Mahiro.MODULES.getModule(AntiBot.class);
    ...
    public static boolean isBot(Entity entity) {
        return (ids.contains(entity.getId()) || !MinecraftClient.getInstance().getNetworkHandler().getPlayerUuids().contains(entity.getUuid())) && Mahiro.MODULES.getModule(AntiBot.class).isEnabled();
    }
