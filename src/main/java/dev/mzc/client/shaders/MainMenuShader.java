...
public class MainMenuShader {
    ...
    public static MainMenuShader getSharedInstance() {
        if (sharedInstance == null) {
            sharedInstance = new MainMenuShader(MainMenuShaderType.BLACK_HOLE);
        }
    ...
    public enum MainMenuShaderType {
        ...
        SEA(ShaderProgram.PULSATING, "脉冲"),
        RAINBOW(ShaderProgram.RAINBOW, "彩虹"),
        GALAXY(ShaderProgram.GALAXY, "星空"),
        BLACK_HOLE(ShaderProgram.BLACK_HOLE, "黑洞"),
        BLACK_HOLE_2(ShaderProgram.BLACK_HOLE_2, "黑洞2");
