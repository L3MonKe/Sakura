...
public class NoRender extends Module {
    ...
    public final BoolValue noBlockBreakParticles = new BoolValue("NoBlockBreakParticles", "无方块破坏粒子", false);
    public final BoolValue noEatParticles = new BoolValue("NoEatParticles", "无进食粒子", false);
    public final BoolValue noPotionParticles = new BoolValue("NoPotionParticles", "无药水粒子", false);
    ...
    public boolean noExplosionParticles() {return isEnabled() && noExplosionParticles.get();}

    public boolean noBlockBreakParticles() {return isEnabled() && noBlockBreakParticles.get();}

    public boolean noEatParticles() {return isEnabled() && noEatParticles.get();}

    public boolean noPotionParticles() {return isEnabled() && noPotionParticles.get();}
}