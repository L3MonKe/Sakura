...
import dev.sakura.client.auth.crypto.*;
...
public final class AuthClient {
    ...
    private static final String DEFAULT_BASE_URL = "http://101.43.59.126:25566";
    ...
    public CompletableFuture<AuthVerifyResult> login(String username, String password, String deviceId) {
        ...
        return handshake()
                .thenCompose(session -> {
                    ...
                    payload.addProperty("clientVersion", Sakura.MOD_VER);
