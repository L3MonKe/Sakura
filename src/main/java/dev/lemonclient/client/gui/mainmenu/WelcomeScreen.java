package dev.lemonclient.client.gui.mainmenu;

import dev.lemonclient.client.LemonClient;
import dev.lemonclient.client.gui.clickgui.component.ModuleComponent;
import dev.lemonclient.client.gui.clickgui.panel.CategoryPanel;
import dev.lemonclient.client.gui.component.AdvancedColorPicker;
...
import dev.lemonclient.client.shaders.MainMenuShader;
import dev.lemonclient.client.utils.TranslationManager;
...
public class WelcomeScreen extends Screen {
    ...
    private void loadPi8Image() {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                InputStream is = LemonClient.class.getResourceAsStream("/assets/lemonclient/textures/pi8.jpg");
                if (is == null) {
