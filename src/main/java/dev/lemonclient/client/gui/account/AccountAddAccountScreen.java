package dev.lemonclient.client.gui.account;

import com.mojang.blaze3d.systems.RenderSystem;
import dev.lemonclient.client.LemonClient;
import dev.lemonclient.client.account.msa.exception.MSAAuthException;
import dev.lemonclient.client.account.type.MinecraftAccount;
import dev.lemonclient.client.account.type.impl.CrackedAccount;
import dev.lemonclient.client.account.type.impl.MicrosoftAccount;
import dev.lemonclient.client.gui.component.SakuraButton;
import dev.lemonclient.client.gui.component.SakuraTextField;
import dev.lemonclient.client.gui.theme.SakuraTheme;
import dev.lemonclient.client.manager.Managers;
import dev.lemonclient.client.manager.impl.AccountManager;
import dev.lemonclient.client.nanovg.NanoVGRenderer;
import dev.lemonclient.client.nanovg.font.FontLoader;
import dev.lemonclient.client.nanovg.util.NanoVGHelper;
import dev.lemonclient.client.utils.render.Shader2DUtil;
