...
import dev.lemonclient.client.events.player.StrafeEvent;
import dev.lemonclient.client.manager.Managers;
import dev.lemonclient.client.manager.impl.RotationManager;
import dev.lemonclient.client.module.Category;
import dev.lemonclient.client.module.Module;
import dev.lemonclient.client.utils.math.MathUtil;
import dev.lemonclient.client.utils.player.FindItemResult;
import dev.lemonclient.client.utils.player.InvUtil;
import dev.lemonclient.client.utils.player.MovementUtil;
import dev.lemonclient.client.utils.rotation.MovementFix;
import dev.lemonclient.client.utils.rotation.RaytraceUtil;
import dev.lemonclient.client.utils.rotation.RotationUtil;
import dev.lemonclient.client.utils.vector.Rotation;
import dev.lemonclient.client.utils.world.BlockUtil;
