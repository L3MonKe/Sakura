package dev.lemonclient.client.module.impl.movement;

import dev.lemonclient.client.events.EventType;
import dev.lemonclient.client.events.client.TickEvent;
import dev.lemonclient.client.events.entity.BlockPushEvent;
import dev.lemonclient.client.events.entity.EntityPushEvent;
import dev.lemonclient.client.events.entity.EntityVelocityUpdateEvent;
import dev.lemonclient.client.events.input.MoveInputEvent;
import dev.lemonclient.client.events.packet.PacketEvent;
import dev.lemonclient.client.events.render.Render3DEvent;
import dev.lemonclient.client.mixin.accessor.IEntityVelocityUpdateS2CPacket;
import dev.lemonclient.client.mixin.accessor.IExplosionS2CPacket;
import dev.lemonclient.client.module.Category;
import dev.lemonclient.client.module.Module;
import dev.lemonclient.client.module.impl.combat.AntiBot;
import dev.lemonclient.client.utils.entity.EntityUtil;
import dev.lemonclient.client.utils.player.MovementUtil;
import dev.lemonclient.client.utils.render.Render3DUtil;
