package dev.lemonclient.client.shaders;

import com.mojang.blaze3d.systems.RenderSystem;
import dev.lemonclient.satin.api.ManagedCoreShader;
import dev.lemonclient.satin.api.ShaderEffectManager;
import dev.lemonclient.satin.api.uniform.SamplerUniform;
import dev.lemonclient.satin.api.uniform.Uniform1f;
import dev.lemonclient.satin.api.uniform.Uniform2f;
import dev.lemonclient.satin.api.uniform.Uniform4f;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance().manageCoreShader(Identifier.of("lemonclient", "core/blur"), VertexFormats.POSITION);
