...
#include "dev_sakura_client_Mahiro_i4_6.hpp"

// dev/sakura/client/Mahiro_i4
namespace native_jvm::classes::__ngen_dev_sakura_client_Mahiro_i4_6 {
    ...
    jobject JNICALL __ngen_native_toString1(JNIEnv *env, jobject obj) {
        ...
        cstack2 = cstack1;
        // New stack: 3
        // LDC Ldev/sakura/client/Mahiro_i4;; Stack: 3
        ...
        // New stack: 6
        // LDC (Ldev/sakura/client/Mahiro_i4;)Ljava/lang/String;; Stack: 6
        ...
        cstack9.i = 0;
        // New stack: 10
        // LDC Ldev/sakura/client/Mahiro_i4;; Stack: 10
        ...
        cstack9.i = 1;
        // New stack: 10
        // LDC mahiro_y;mahiro_H;mahiro_M; Stack: 10
        ...
        // New stack: 11
        // LDC Ldev/sakura/client/Mahiro_i4;; Stack: 11
        ...
        // New stack: 13
        // LDC [B; Stack: 13
        if (!cclasses[7] || env->IsSameObject(cclasses[7], NULL)) { cclasses_mtx[7].lock(); if (!cclasses[7] || env->IsSameObject(cclasses[7], NULL)) { if (jclass clazz = env->FindClass(((char *)(string_pool + 3883LL)))) { cclasses[7] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[7].unlock(); if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; } } cstack13.l = (cclasses[7]);
        // New stack: 14
        // INVOKEVIRTUAL java/lang/invoke/MethodHandles$Lookup.findGetter(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/invoke/MethodHandle;; Stack: 14
        if (!cclasses[5] || env->IsSameObject(cclasses[5], NULL)) { cclasses_mtx[5].lock(); if (!cclasses[5] || env->IsSameObject(cclasses[5], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[7]))) { cclasses[5] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[5].unlock(); if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; } } if (!cmethods[2]) { cmethods[2] = env->GetMethodID((cclasses[5]), ((char *)(string_pool + 907LL)), ((char *)(string_pool + 918LL))); if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; }  } if (cstack10.l == nullptr) utils::throw_re(env, ((char *)(string_pool + 353LL)), ((char *)(string_pool + 384LL)), -1); else { cstack10.l = env->CallObjectMethod(cstack10.l, (cmethods[2]), cstack11.l, cstack12.l, cstack13.l); refs.insert(cstack10.l); } 
        if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; }
        ...
        // New stack: 2
        // FRAME FULL L: [dev/sakura/client/Mahiro_i4] S: [dev/sakura/client/Mahiro_i4, java/lang/Object]; Stack: 2
        ...
        // New stack: 0
        // FRAME FULL L: [dev/sakura/client/Mahiro_i4] S: [dev/sakura/client/Mahiro_i4, java/lang/invoke/MethodHandle]; Stack: 0
        refs.erase(cstack0.l); refs.erase(cstack1.l); 
        refs.erase(clocal0.l); 
        utils::clear_refs(env, refs);
        // New stack: 2
        // INVOKESTATIC native/magic/1/invoke/obfuscator0.7736767991064643.a(Ldev/sakura/client/Mahiro_i4;Ljava/lang/invoke/MethodHandle;)Ljava/lang/String;; Stack: 2
    ...
    jint JNICALL __ngen_native_hashCode2(JNIEnv *env, jobject obj) {
        ...
        std::swap(cstack5, cstack4);
        // New stack: 6
        // LDC (Ldev/sakura/client/Mahiro_i4;)I; Stack: 6
        ...
        utils::clear_refs(env, refs);
        // New stack: 2
        // INVOKESTATIC native/magic/1/invoke/obfuscator0.7736767991064643.a(Ldev/sakura/client/Mahiro_i4;Ljava/lang/invoke/MethodHandle;)I; Stack: 2
    ...
    jboolean JNICALL __ngen_native_equals3(JNIEnv *env, jobject obj, jobject arg0) {
        ...
        cstack3 = cstack2;
        // New stack: 4
        // LDC Ldev/sakura/client/Mahiro_i4;; Stack: 4
        ...
        std::swap(cstack6, cstack5);
        // New stack: 7
        // LDC (Ldev/sakura/client/Mahiro_i4;Ljava/lang/Object;)Z; Stack: 7
        ...
        cstack10.i = 1;
        // New stack: 11
        // LDC mahiro_y;mahiro_H;mahiro_M; Stack: 11
        ...
        // New stack: 12
        // LDC Ldev/sakura/client/Mahiro_i4;; Stack: 12
        ...
        L3: if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; }
        // New stack: 3
        // FRAME FULL L: [dev/sakura/client/Mahiro_i4, java/lang/Object] S: [dev/sakura/client/Mahiro_i4, java/lang/Object, java/lang/Object]; Stack: 3
        ...
        // New stack: 0
        // FRAME FULL L: [dev/sakura/client/Mahiro_i4, java/lang/Object] S: [dev/sakura/client/Mahiro_i4, java/lang/Object, java/lang/invoke/MethodHandle]; Stack: 0
        refs.erase(cstack0.l); refs.erase(cstack1.l); refs.erase(cstack2.l); 
        refs.erase(clocal0.l); refs.erase(clocal1.l); 
        utils::clear_refs(env, refs);
        // New stack: 3
        // INVOKESTATIC native/magic/1/invoke/obfuscator0.7736767991064643.a(Ldev/sakura/client/Mahiro_i4;Ljava/lang/Object;Ljava/lang/invoke/MethodHandle;)Z; Stack: 3
    ...
    jobject JNICALL __ngen_native_Mahiro_y4(JNIEnv *env, jobject obj) {
        ...
        cstack0.l = clocal0.l; refs.insert(cstack0.l);
        // New stack: 1
        // LDC 4609983581824642291; Stack: 1
        cstack1.j = 4609983581824642291LL;
        // New stack: 3
        // LLOAD 1; Stack: 3
        cstack3.j = clocal1.j;
        // New stack: 5
        ...
        cstack6 = cstack5;
        // New stack: 7
        // LDC Ldev/sakura/client/Mahiro_i4;; Stack: 7
        ...
        L3: if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; }
        // New stack: 6
        // FRAME FULL L: [dev/sakura/client/Mahiro_i4, 4] S: [dev/sakura/client/Mahiro_i4, 4, 4, java/lang/Object]; Stack: 6
        ...
        L4: if (env->ExceptionCheck()) { return (jobject) 0; }
        // New stack: 0
        // FRAME FULL L: [dev/sakura/client/Mahiro_i4, 4] S: [dev/sakura/client/Mahiro_i4, 4, 4, java/lang/invoke/MethodHandle]; Stack: 0
        refs.erase(cstack0.l); refs.erase(cstack5.l); 
        refs.erase(clocal0.l); 
        utils::clear_refs(env, refs);
        // New stack: 6
    ...
    jarray JNICALL __ngen_native_Mahiro_H5(JNIEnv *env, jobject obj) {
        ...
        // GETSTATIC dev/sakura/client/Mahiro_i4.a J; Stack: 0
        if (!cclasses[13]  || env->IsSameObject(cclasses[13], NULL)) { cclasses_mtx[13].lock(); if (!cclasses[13] || env->IsSameObject(cclasses[13], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[0]))) { cclasses[13] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[13].unlock(); if (env->ExceptionCheck()) { return (jarray) 0; } } if (!cfields[0]) { cfields[0] = env->GetStaticFieldID((cclasses[13]), ((char *)(string_pool + 78LL)), ((char *)(string_pool + 80LL))); if (env->ExceptionCheck()) { return (jarray) 0; }  } cstack0.j = env->GetStaticLongField((cclasses[13]), (cfields[0])); 
        if (env->ExceptionCheck()) { return (jarray) 0; }
        // New stack: 2
        // LDC 77036311914319; Stack: 2
        cstack2.j = 77036311914319LL;
        // New stack: 4
        // LXOR; Stack: 4
        cstack0.j = cstack0.j ^ cstack2.j;
        // New stack: 2
        ...
        cstack0.l = clocal0.l; refs.insert(cstack0.l);
        // New stack: 1
        // LDC 1795867466654624239; Stack: 1
        cstack1.j = 1795867466654624239LL;
        // New stack: 3
        // LLOAD 1; Stack: 3
        cstack3.j = clocal1.j;
        // New stack: 5
        ...
        if (!cclasses[11] || env->IsSameObject(cclasses[11], NULL)) { cclasses_mtx[11].lock(); if (!cclasses[11] || env->IsSameObject(cclasses[11], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[18]))) { cclasses[11] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[11].unlock(); if (env->ExceptionCheck()) { return (jarray) 0; } } if (!cmethods[8]) { cmethods[8] = env->GetStaticMethodID((cclasses[11]), ((char *)(string_pool + 1377LL)), ((char *)(string_pool + 1392LL))); if (env->ExceptionCheck()) { return (jarray) 0; }  } cstack0.l = env->CallStaticObjectMethod((cclasses[11]), (cmethods[8]), cstack0.l, cstack1.j, cstack3.j, cstack5.l); refs.insert(cstack0.l); 
        if (env->ExceptionCheck()) { return (jarray) 0; }
        // New stack: 1
        // CHECKCAST [B; Stack: 1
        if (!cclasses[7] || env->IsSameObject(cclasses[7], NULL)) { cclasses_mtx[7].lock(); if (!cclasses[7] || env->IsSameObject(cclasses[7], NULL)) { if (jclass clazz = env->FindClass(((char *)(string_pool + 3883LL)))) { cclasses[7] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[7].unlock(); if (env->ExceptionCheck()) { return (jarray) 0; } } if (cstack0.l != nullptr && !env->IsInstanceOf(cstack0.l, (cclasses[7]))) { utils::throw_re(env, ((char *)(string_pool + 409LL)), (std::string(((char *)(string_pool + 438LL))) + std::string(((char *)(string_pool + 3883LL)))).c_str(), -1); 
        if (env->ExceptionCheck()) { return (jarray) 0; } } 
        // New stack: 1
        // ARETURN; Stack: 1
    ...
    // Mahiro_M()[B
    jarray JNICALL __ngen_native_Mahiro_M6(JNIEnv *env, jobject obj) {
        jclass clazz = utils::get_class_from_object(env, obj);
        if (env->ExceptionCheck()) { return (jarray) 0; }
        jobject classloader = utils::get_classloader_from_class(env, clazz);
        if (env->ExceptionCheck()) { return (jarray) 0; }
        ...
        if (env->ExceptionCheck()) { return (jarray) 0; }
        // New stack: 2
        // LDC 73232408573792; Stack: 2
        cstack2.j = 73232408573792LL;
        // New stack: 4
        // LXOR; Stack: 4
        cstack0.j = cstack0.j ^ cstack2.j;
        // New stack: 2
        ...
        cstack0.l = clocal0.l; refs.insert(cstack0.l);
        // New stack: 1
        // LDC 5192714437995620966; Stack: 1
        cstack1.j = 5192714437995620966LL;
        // New stack: 3
        // LLOAD 1; Stack: 3
        cstack3.j = clocal1.j;
        // New stack: 5
    ...
    // <clinit>()V
    void JNICALL __ngen_special_clinit_6_7(JNIEnv *env, jobject ignored_hidden, jclass clazz) {
        ...
        if (env->ExceptionCheck()) { return (void) 0; }
        // New stack: 2
        // PUTSTATIC dev/sakura/client/Mahiro_i4.a J; Stack: 2
        if (!cclasses[13]  || env->IsSameObject(cclasses[13], NULL)) { cclasses_mtx[13].lock(); if (!cclasses[13] || env->IsSameObject(cclasses[13], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[0]))) { cclasses[13] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[13].unlock(); if (env->ExceptionCheck()) { return (void) 0; } } if (!cfields[0]) { cfields[0] = env->GetStaticFieldID((cclasses[13]), ((char *)(string_pool + 78LL)), ((char *)(string_pool + 80LL))); if (env->ExceptionCheck()) { return (void) 0; }  } env->SetStaticLongField((cclasses[13]), (cfields[0]), cstack0.j); 
        if (env->ExceptionCheck()) { return (void) 0; }
        // New stack: 0
        // RETURN; Stack: 0
        return;
    ...
    void __ngen_register_methods(JNIEnv *env, jclass clazz) {
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 14928LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[10] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 14955LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[13] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 14964LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[0] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 6283LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[28] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 14992LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[14] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 15001LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[20] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 15034LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[11] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 15043LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[9] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 15093LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[22] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        JNINativeMethod __ngen_methods[] = {
            ...
            { ((char *)(string_pool + 14905LL)), ((char *)(string_pool + 851LL)), (void *)&__ngen_native_Mahiro_y4 },
            { ((char *)(string_pool + 10786LL)), ((char *)(string_pool + 14914LL)), (void *)&__ngen_native_Mahiro_H5 },
            { ((char *)(string_pool + 14919LL)), ((char *)(string_pool + 14914LL)), (void *)&__ngen_native_Mahiro_M6 },
        };

        if (clazz) env->RegisterNatives(clazz, __ngen_methods, sizeof(__ngen_methods) / sizeof(__ngen_methods[0]));
        if (env->ExceptionCheck()) { fprintf(stderr, "Exception occured while registering native_jvm for %s\n", ((char *)(string_pool + 14964LL))); fflush(stderr); env->ExceptionDescribe(); env->ExceptionClear(); }

        {
            jclass hidden_class = env->FindClass(((char *)(string_pool + 3543LL)));
            JNINativeMethod __ngen_hidden_methods[] = {
                { ((char *)(string_pool + 15144LL)), ((char *)(string_pool + 3587LL)), (void *)&__ngen_special_clinit_6_7 },
            };
