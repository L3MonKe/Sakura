...
#include "dev_sakura_client_Mahiro_AA_1.hpp"

// dev/sakura/client/Mahiro_AA
namespace native_jvm::classes::__ngen_dev_sakura_client_Mahiro_AA_1 {
    ...
    jobject JNICALL __ngen_native_toString1(JNIEnv *env, jobject obj) {
        ...
        cstack2 = cstack1;
        // New stack: 3
        // LDC Ldev/sakura/client/Mahiro_AA;; Stack: 3
        ...
        // New stack: 6
        // LDC (Ldev/sakura/client/Mahiro_AA;)Ljava/lang/String;; Stack: 6
        ...
        cstack9.i = 0;
        // New stack: 10
        // LDC Ldev/sakura/client/Mahiro_AA;; Stack: 10
        ...
        cstack9.i = 1;
        // New stack: 10
        // LDC mahiro_A;mahiro_j; Stack: 10
        ...
        // New stack: 2
        // FRAME FULL L: [dev/sakura/client/Mahiro_AA] S: [dev/sakura/client/Mahiro_AA, java/lang/Object]; Stack: 2
        ...
        // New stack: 0
        // FRAME FULL L: [dev/sakura/client/Mahiro_AA] S: [dev/sakura/client/Mahiro_AA, java/lang/invoke/MethodHandle]; Stack: 0
        refs.erase(cstack0.l); refs.erase(cstack1.l); 
        refs.erase(clocal0.l); 
        utils::clear_refs(env, refs);
        // New stack: 2
        // INVOKESTATIC native/magic/1/invoke/obfuscator0.11716030067971395.a(Ldev/sakura/client/Mahiro_AA;Ljava/lang/invoke/MethodHandle;)Ljava/lang/String;; Stack: 2
    ...
    jint JNICALL __ngen_native_hashCode2(JNIEnv *env, jobject obj) {
        ...
        std::swap(cstack5, cstack4);
        // New stack: 6
        // LDC (Ldev/sakura/client/Mahiro_AA;)I; Stack: 6
        ...
        utils::clear_refs(env, refs);
        // New stack: 2
        // INVOKESTATIC native/magic/1/invoke/obfuscator0.11716030067971395.a(Ldev/sakura/client/Mahiro_AA;Ljava/lang/invoke/MethodHandle;)I; Stack: 2
    ...
    jboolean JNICALL __ngen_native_equals3(JNIEnv *env, jobject obj, jobject arg0) {
        ...
        cstack3 = cstack2;
        // New stack: 4
        // LDC Ldev/sakura/client/Mahiro_AA;; Stack: 4
        ...
        std::swap(cstack6, cstack5);
        // New stack: 7
        // LDC (Ldev/sakura/client/Mahiro_AA;Ljava/lang/Object;)Z; Stack: 7
        ...
        cstack10.i = 1;
        // New stack: 11
        // LDC mahiro_A;mahiro_j; Stack: 11
        ...
        L3: if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; }
        // New stack: 3
        // FRAME FULL L: [dev/sakura/client/Mahiro_AA, java/lang/Object] S: [dev/sakura/client/Mahiro_AA, java/lang/Object, java/lang/Object]; Stack: 3
        ...
        // New stack: 0
        // FRAME FULL L: [dev/sakura/client/Mahiro_AA, java/lang/Object] S: [dev/sakura/client/Mahiro_AA, java/lang/Object, java/lang/invoke/MethodHandle]; Stack: 0
        refs.erase(cstack0.l); refs.erase(cstack1.l); refs.erase(cstack2.l); 
        refs.erase(clocal0.l); refs.erase(clocal1.l); 
        utils::clear_refs(env, refs);
        // New stack: 3
        // INVOKESTATIC native/magic/1/invoke/obfuscator0.11716030067971395.a(Ldev/sakura/client/Mahiro_AA;Ljava/lang/Object;Ljava/lang/invoke/MethodHandle;)Z; Stack: 3
    ...
    // Mahiro_A()Ljava/lang/String;
    jobject JNICALL __ngen_native_Mahiro_A4(JNIEnv *env, jobject obj) {
        jclass clazz = utils::get_class_from_object(env, obj);
        if (env->ExceptionCheck()) { return (jobject) 0; }
        jobject classloader = utils::get_classloader_from_class(env, clazz);
        if (env->ExceptionCheck()) { return (jobject) 0; }
        ...
        cstack0.l = clocal0.l; refs.insert(cstack0.l);
        // New stack: 1
        // LDC -4281541907340004773; Stack: 1
        cstack1.j = -4281541907340004773LL;
        // New stack: 3
        // LLOAD 1; Stack: 3
        cstack3.j = clocal1.j;
        // New stack: 5
        ...
        cstack6 = cstack5;
        // New stack: 7
        // LDC Ldev/sakura/client/Mahiro_AA;; Stack: 7
        ...
        L3: if (env->ExceptionCheck()) { jthrowable exception = env->ExceptionOccurred(); env->ExceptionClear(); cstack0.l = exception; refs.insert(exception); goto L_CATCH_0; }
        // New stack: 6
        // FRAME FULL L: [dev/sakura/client/Mahiro_AA, 4] S: [dev/sakura/client/Mahiro_AA, 4, 4, java/lang/Object]; Stack: 6
        ...
        L4: if (env->ExceptionCheck()) { return (jobject) 0; }
        // New stack: 0
        // FRAME FULL L: [dev/sakura/client/Mahiro_AA, 4] S: [dev/sakura/client/Mahiro_AA, 4, 4, java/lang/invoke/MethodHandle]; Stack: 0
        refs.erase(cstack0.l); refs.erase(cstack5.l); 
        refs.erase(clocal0.l); 
        utils::clear_refs(env, refs);
        // New stack: 6
    ...
    // Mahiro_j()J
    jlong JNICALL __ngen_native_Mahiro_j5(JNIEnv *env, jobject obj) {
        jclass clazz = utils::get_class_from_object(env, obj);
        if (env->ExceptionCheck()) { return (jlong) 0; }
        jobject classloader = utils::get_classloader_from_class(env, clazz);
        if (env->ExceptionCheck()) { return (jlong) 0; }
        if (classloader == nullptr) { env->FatalError(((char *)(string_pool + 54LL))); return (jlong) 0; }
        ...
        // GETSTATIC dev/sakura/client/Mahiro_AA.a J; Stack: 0
        if (!cclasses[13]  || env->IsSameObject(cclasses[13], NULL)) { cclasses_mtx[13].lock(); if (!cclasses[13] || env->IsSameObject(cclasses[13], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[0]))) { cclasses[13] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[13].unlock(); if (env->ExceptionCheck()) { return (jlong) 0; } } if (!cfields[1]) { cfields[1] = env->GetStaticFieldID((cclasses[13]), ((char *)(string_pool + 213LL)), ((char *)(string_pool + 215LL))); if (env->ExceptionCheck()) { return (jlong) 0; }  } cstack0.j = env->GetStaticLongField((cclasses[13]), (cfields[1])); 
        if (env->ExceptionCheck()) { return (jlong) 0; }
        // New stack: 2
        // LDC 81112447296343; Stack: 2
        cstack2.j = 81112447296343LL;
        // New stack: 4
        // LXOR; Stack: 4
        cstack0.j = cstack0.j ^ cstack2.j;
        // New stack: 2
        ...
        cstack0.l = clocal0.l; refs.insert(cstack0.l);
        // New stack: 1
        // LDC -6251457675811967307; Stack: 1
        cstack1.j = -6251457675811967307LL;
        // New stack: 3
        // LLOAD 1; Stack: 3
        cstack3.j = clocal1.j;
        // New stack: 5
        ...
        // New stack: 3
        // INVOKESPECIAL java/lang/BootstrapMethodError.<init>(Ljava/lang/Throwable;)V; Stack: 3
        if (!cclasses[10] || env->IsSameObject(cclasses[10], NULL)) { cclasses_mtx[10].lock(); if (!cclasses[10] || env->IsSameObject(cclasses[10], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[17]))) { cclasses[10] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[10].unlock(); if (env->ExceptionCheck()) { return (jlong) 0; } } if (!cmethods[4]) { cmethods[4] = env->GetMethodID((cclasses[10]), ((char *)(string_pool + 631LL)), ((char *)(string_pool + 638LL))); if (env->ExceptionCheck()) { return (jlong) 0; }  } if (cstack1.l == nullptr) utils::throw_re(env, ((char *)(string_pool + 74LL)), ((char *)(string_pool + 663LL)), -1); else env->CallNonvirtualVoidMethod(cstack1.l, (cclasses[10]), (cmethods[4]), cstack2.l); 
        if (env->ExceptionCheck()) { return (jlong) 0; }
        // New stack: 1
        // LABEL L5; Stack: 1
        ...
        utils::clear_refs(env, refs);
        // New stack: 6
        // INVOKESTATIC native/magic/1/invoke/obfuscator0.11716030067971395.a(Ljava/lang/Object;JJLjava/lang/invoke/MethodHandle;)J; Stack: 6
        if (!cclasses[11] || env->IsSameObject(cclasses[11], NULL)) { cclasses_mtx[11].lock(); if (!cclasses[11] || env->IsSameObject(cclasses[11], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[18]))) { cclasses[11] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[11].unlock(); if (env->ExceptionCheck()) { return (jlong) 0; } } if (!cmethods[9]) { cmethods[9] = env->GetStaticMethodID((cclasses[11]), ((char *)(string_pool + 5525LL)), ((char *)(string_pool + 5540LL))); if (env->ExceptionCheck()) { return (jlong) 0; }  } cstack0.j = env->CallStaticLongMethod((cclasses[11]), (cmethods[9]), cstack0.l, cstack1.j, cstack3.j, cstack5.l); 
        if (env->ExceptionCheck()) { return (jlong) 0; }
        // New stack: 2
        // LRETURN; Stack: 2
    ...
    void JNICALL __ngen_special_clinit_1_6(JNIEnv *env, jobject ignored_hidden, jclass clazz) {
        ...
        if (env->ExceptionCheck()) { return (void) 0; }
        // New stack: 2
        // PUTSTATIC dev/sakura/client/Mahiro_AA.a J; Stack: 2
        if (!cclasses[13]  || env->IsSameObject(cclasses[13], NULL)) { cclasses_mtx[13].lock(); if (!cclasses[13] || env->IsSameObject(cclasses[13], NULL)) { if (jclass clazz = utils::find_class_wo_static(env, classloader, (cstrings[0]))) { cclasses[13] = (jclass) env->NewWeakGlobalRef(clazz); env->DeleteLocalRef(clazz); } } cclasses_mtx[13].unlock(); if (env->ExceptionCheck()) { return (void) 0; } } if (!cfields[1]) { cfields[1] = env->GetStaticFieldID((cclasses[13]), ((char *)(string_pool + 213LL)), ((char *)(string_pool + 215LL))); if (env->ExceptionCheck()) { return (void) 0; }  } env->SetStaticLongField((cclasses[13]), (cfields[1]), cstack0.j); 
        if (env->ExceptionCheck()) { return (void) 0; }
        // New stack: 0
        // RETURN; Stack: 0
        return;
    ...
    void __ngen_register_methods(JNIEnv *env, jclass clazz) {
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 5595LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[9] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 5645LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[10] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 3666LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[14] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 5663LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[22] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 5755LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[11] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 5774LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[0] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 5834LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[28] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 5858LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[13] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        if (jstring str = env->NewStringUTF(((char *)(string_pool + 6047LL)))) { if (jstring int_str = utils::get_interned(env, str)) { cstrings[20] = (jstring) env->NewGlobalRef(int_str); env->DeleteLocalRef(str); env->DeleteLocalRef(int_str); } }
        ...
        JNINativeMethod __ngen_methods[] = {
            ...
            { ((char *)(string_pool + 5507LL)), ((char *)(string_pool + 2254LL)), (void *)&__ngen_native_Mahiro_A4 },
            { ((char *)(string_pool + 5516LL)), ((char *)(string_pool + 186LL)), (void *)&__ngen_native_Mahiro_j5 },
        };

        if (clazz) env->RegisterNatives(clazz, __ngen_methods, sizeof(__ngen_methods) / sizeof(__ngen_methods[0]));
        if (env->ExceptionCheck()) { fprintf(stderr, "Exception occured while registering native_jvm for %s\n", ((char *)(string_pool + 5774LL))); fflush(stderr); env->ExceptionDescribe(); env->ExceptionClear(); }

        {
            jclass hidden_class = env->FindClass(((char *)(string_pool + 5069LL)));
            JNINativeMethod __ngen_hidden_methods[] = {
                { ((char *)(string_pool + 6080LL)), ((char *)(string_pool + 5112LL)), (void *)&__ngen_special_clinit_1_6 },
            };
