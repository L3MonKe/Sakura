...
buildConfig {
    ...
    val pinnedKeyRaw = (findProperty("pinned_server_signing_key_x509_base64") as String?) ?: System.getenv("PINNED_SERVER_SIGNING_KEY_X509_BASE64") ?: ""
...
configure<LoomGradleExtensionAPI> {
    accessWidenerPath.set(file("src/main/resources/mahiro.accesswidener"))
}
...
val minecraftModsDir = file("C:/Users/L3MonKe/Desktop/MC/.minecraft/versions/Mahiro-1.21.11/mods")
